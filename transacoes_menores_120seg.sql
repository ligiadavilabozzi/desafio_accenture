-- Para saber os clientes fraudados nas sa�das e a data do fraude: 
...
--Para saber quantos clientes com fraude na sa�da
...
-- Para selecionar nome telefone e e-mail dos clientes fraudados na sa�da
...
-- Inser��o de clientes, nome, telefone, email na tabela de fraudes entradas:
...
-- Criando a tabela de fraudes na sa�da
...
-- Inser��o de clientes, nome, telefone, email na tabela de fraudes sa�das:
